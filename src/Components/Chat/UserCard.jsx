  ...
  return (
    <div className="flex p-4 w-fit min-w-400px border-b-2 border-t-stone-600">
      <div className="mr-2 rounded-full overflow-hidden w-8 h-8">
        <img className="w-full h-full object-contain" src={userImage} alt="" />
      </div>
      <div className="w-full">
        ...
        <div className="flex justify-between align-center">
          ...
          {noRead && <p>{noRead}</p>}
          {success && (
            <img src="./Assets/Images/success.svg" alt="success logo" />
          )}
          {error && <img src="./Assets/Images/error.svg" alt="error logo" />}
          {pending && (
            <img src="./Assets/Images/pending.svg" alt="pending logo" />
          )}
        </div>
      </div>
    </div>
